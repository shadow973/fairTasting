...
import { Image, Platform, ScrollView, StyleSheet, TouchableHighlight } from 'react-native';
...
const FTWinebarCardHorizontal = ({ id, name, short_description, event_start_time, event_end_time, image_path, location_id, distance, mylink }: CardProps) => {
    ...
    return (
        <TouchableHighlight onPress={() => navigate('CustomerDetails', { id })} underlayColor="white">
