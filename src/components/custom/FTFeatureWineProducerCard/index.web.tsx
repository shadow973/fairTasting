...
interface FTFeatureWineProducerProps {
    location: string;
    title: string;
    image: string;
}

const FTFeatureWineProducerCard = ({ location, title, image }: FTFeatureWineProducerProps) => {
...
export default FTFeatureWineProducerCard;
