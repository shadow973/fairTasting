...
const Button = ({label, onPress, secondary, dark, underline, signin, signinText, square, strong, brandtext, slim, darkOutline, style}:ButtonProps) => {
  return (
    <TouchableOpacity
      onPress={onPress}
      style={[styles.base, (style && style), (secondary && styles.secondary), ((dark && !secondary) && styles.dark), (signin && styles.signin), (square && styles.square),(slim && styles.slim), (darkOutline && styles.darkOutline)]}>
